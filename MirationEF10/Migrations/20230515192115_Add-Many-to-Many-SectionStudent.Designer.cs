...
namespace MirationEF10.Migrations
{
    ...
    [Migration("20230515192115_Add-Many-to-Many-SectionStudent")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MirationEF10.Data.Config.SectionStudent", b =>
                {
                    b.Property<int>("SectionId")
                        .HasColumnType("int");
                    ...
                    b.ToTable("SectionStudents", (string)null);
                });
            ...
            modelBuilder.Entity("MirationEF10.Entities.Student", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MirationEF10.Data.Config.SectionStudent", b =>
                {
                    b.HasOne("MirationEF10.Entities.Section", "Section")
                        .WithMany("SectionStudents")
                        .HasForeignKey("SectionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MirationEF10.Entities.Student", "Student")
                        .WithMany("SectionStudents")
